...
final readonly class CreateAd
{
    ...
    {
        $ad = Ad::withoutSyncingToSearch(function () use ($data, $images, $propertyConditionPdf, $isDraft): Ad {
            return DB::transaction(function () use ($data, $images, $propertyConditionPdf, $isDraft): Ad {
                $ad = new Ad;
                $ad->fill([
                    // Core fields
                    'title' => $data['title'],
