...
final class DisputeStatusChangedMail extends Mailable implements ShouldQueue
{
    ...
    public function envelope(): Envelope
    {
        return new Envelope(
            ...
            subject: "Litige {$this->dispute->reference} — {$this->dispute->status->getLabel()}",
        );
    }
    ...
    {
        return new Content(
            view: 'emails.dispute-status-changed',
