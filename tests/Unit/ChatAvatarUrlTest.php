...
it('normalizes protocol-relative URLs to https', function () {
    expect(ChatAvatarUrl::resolve('//img.clerk.com/v/test/photo'))
        ->toBe('https://img.clerk.com/v/test/photo');
});

it('preserves absolute http(s) URLs', function () {
...
it('resolves relative keys on the app media disk', function () {
    Storage::fake('public');
