...
=== local commands (no Sail) ===

## Exécution locale

**Ne pas utiliser Laravel Sail** sur ce dépôt : exécuter PHP, Artisan, Composer et npm directement sur la machine hôte.

- Artisan : `php artisan …`
- Composer : `composer …`
- Pint / outils : `vendor/bin/pint`, etc.
- Assets / Next.js : `npm …` à la racine Laravel ou sous `keyhome-frontend-next/` selon le script.
