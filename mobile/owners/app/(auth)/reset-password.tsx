 ...
 * confirmation. On success, offers to return to login.
 */
      ...
      >
        ...
        {done ? (
          <YStack flex={1} alignItems="center" justifyContent="center" gap={14}>
            ...
            <Button size="$5" backgroundColor="$brand" color="white" fontWeight="700" borderRadius={14} marginTop={10} onPress={() => router.replace('/(auth)/login')}>
              Se connecter
            </Button>
          </YStack>
        ) : (
