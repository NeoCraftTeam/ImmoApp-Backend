...
/**
 * Forgot password — collect the email, trigger the reset link, then
 * route to reset-password (where the owner pastes the received code).
 */
  ...
  return (
    <>
      ...
      >
        ...
        {sent ? (
          <YStack padding={16} borderRadius={14} backgroundColor={`${brand.success}15`} gap={8}>
            ...
            <Paragraph fontSize={13} color="$slate700" lineHeight={20}>
              Vérifiez votre boîte mail puis collez le code dans l’écran « Réinitialiser le mot de passe ».
            </Paragraph>
            <Button
              size="$4"
