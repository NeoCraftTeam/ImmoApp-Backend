 ...
 */
export function isOptimistic(m: ConversationMessage): boolean {
  return (
 ...
 */
export function latestSettledCursor(list: ConversationMessage[]): string | null {
...
export function mergeFreshPage(
  ...
  freshPageAscending: ConversationMessage[],
): ConversationMessage[] {
...
export async function runDeltaSync(opts: {
  ...
  applyFresh: (fresh: ConversationMessage[]) => void;
