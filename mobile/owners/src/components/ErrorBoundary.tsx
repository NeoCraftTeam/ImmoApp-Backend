...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render(): ReactNode {
    ...
    return (
      <YStack flex={1} backgroundColor="$background" padding={24} justifyContent="center">
        <YStack alignItems="center" gap={12}>
          ...
          <Paragraph fontSize={14} color="$slate500" textAlign="center" lineHeight={20}>
            L'écran a planté de façon inattendue. Vos données sont sauvegardées — touchez "Réessayer".
          </Paragraph>
        </YStack>

        {__DEV__ && this.state.error && (
          <ScrollView style={{ maxHeight: 220, marginTop: 18 }} contentContainerStyle={{ padding: 12 }}>
            <YStack
              padding={12}
              borderRadius={10}
            ...
            >
              ...
              <Paragraph fontSize={11} color="$slate700">
