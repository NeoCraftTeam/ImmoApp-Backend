...
import { DELETE_ACCOUNT_CONFIRMATION } from '@/hooks/useUpdateProfile';
      ...
      <YStack flex={1} justifyContent="center" backgroundColor="rgba(0,0,0,0.5)" padding={24}>
        ...
        >
          ...
          <Paragraph fontSize={14} color="$slate700" lineHeight={20}>
            Cette action est irréversible. Vos favoris, messages et données
            seront définitivement effacés. Pour confirmer, tapez exactement :
          </Paragraph>
